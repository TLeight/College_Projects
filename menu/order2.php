...
#Get and sanatize the payment info.
...
#Get and sanatize taxes and couponcodes.
...
if (!empty($_POST['dip'])) {
	$dip=$_POST['dip'];
	$sql =$DBH->prepare("INSERT INTO orders VALUES (NULL, :payment_id, 'Spinache Artichoke dip', :dip)");
