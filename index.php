...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Tyler Leight ePortfolio </title>  
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>Tyler</strong> Leight</h2>
										<p class="lead">Software Enginere, Web Development, Databade Archives. </p>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-left">
									<div class="big-tagline">
										<h2 data-animation="animated zoomInRight">Highly <strong>Motivated</strong></h2>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-center">
									<div class="big-tagline">
										<h2 data-animation="animated zoomInRight"><strong>Experienced</strong>Developer</h2>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3>About</h3>
                    <p class="lead">Hello, I work in the feild of editing and managining computer software and server's. </p>
                </div>
            </div><!-- end title -->
		...
		<div class="container">
			<div class="row text-left stat-wrap">
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					...
					<h3>Knwon Computer Languages</h3>
				</div><!-- end col -->
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="" alt="Referance name" class="img-fluid">
                                <h4></h4>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="" alt="Reference name" class="img-fluid ">
                                <h4></h4>
                            </div>
                            <!-- end testi-meta -->
                        </div>
